<x-guest-layout>
    <div class="text-center mb-6">
        <h3 class="text-2xl font-semibold text-slate-900">Entrar na sua conta</h3>
        <p class="mt-1 text-sm text-slate-500">Acesse sua conta para gerenciar seus ativos</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative mt-2">
                ...
                <x-text-input id="email" class="h-12 pl-12" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
            </div>
        ...
        <div>
            ...
            <div class="relative mt-2">
                ...
                <x-text-input id="password" class="h-12 pl-12" type="password" name="password" required autocomplete="current-password" />
            </div>
        ...
        <div>
            <button type="submit" class="w-full bg-sky-500 hover:bg-sky-600 text-white rounded-xl h-12 shadow-sm font-semibold transition">Entrar</button>
        </div>
